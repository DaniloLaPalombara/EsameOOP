...
public class TempService implements TempInterface {
	...
	/**
	 * Metodo che prende i dati di interesse riguaradanti la città e le temperature
	 * e li utilizza per creare un JSONObject
	 * @Override è un'annotazione utilizzata per indicare la sovrascrizione di un
	 *          metodo che deriva da una superclasse o da un'interfaccia
	 */
	@Override
	...
	/**
	 * Metodo che permette di salvare ogni ora i dati relativi alle temperature di
	 * una città
	 ...
	 * @return vettore contenente gli elementi utili per il calcolo delle
	 *        statistiche
	 */
